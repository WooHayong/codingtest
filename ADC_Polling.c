...
int main(void)
{
	...
	while(1)
	{
             ...
             x   ADC1->CR2 |= ADC_CR2_SWSTART; 	// 0x40000000 (1<<30)
...
{   	// ADC1: PA1(pin 41)
	...
	ADC1->CR1 &= ~(3<<24);		// RES[1:0]=0b00 : 12bit Resolution // 10 비트면 1024까지만 표현 .
	...
	//ADC1->SQR3 |= (1<<0);		// SQ1[4:0]=0b0001 : CH1  ->설정안하면 값이 안나옴 잡음만나옴 
